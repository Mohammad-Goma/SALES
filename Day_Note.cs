...
namespace SALES
{
    public partial class Day_Note : Form
    {
        ...
        public void search_invoice()
        {
            try
            {
                ...
                string sql = "Select ID,ID_Order_Invoice,Amount_of_product,TOTAL,PAYING,The_rest from TBL_ORDER where DATE ='" + Date_N.Text.Trim() + "' ";
        ...
        public void search_billing()
        {
            try
            {
                ...
                string sql2 = "select ID,TOTAL_AMOUNT,TOTAL_AFTER_DISCOUNT,PAY_FIRST,THE_REST from TBL_BILLING where DATE_TIME_NOW = '" + Date_N.Text.Trim() + "' ";
        ...
        public void search_pay()
        {
            try
            {
                ...
                string sql3 = "select ID,ID_ORDER_AUTO,ID_ORDER_HAND,AMOUNT,TOTAL_AFTER_DISCOUNT,Cash,total_rest from TBL_PAY_RECEIPT where DATE_NOW = '" + Date_N.Text.Trim() + "' ";
        ...
        public void search_catch()
        {
            try
            {
                ...
                string sql4 = "select ID,ID_ORDER_AUTO,ID_ORDER_HAND,AMOUNT,TOTAL_AFTER_DISCOUNT,Cash,total_rest from TBL_CATCH_RECEIPT  where DATE_NOW = '" + Date_N.Text.Trim() + "' ";
